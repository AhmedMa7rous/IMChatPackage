...
#ifndef IMCHAT_SWIFT_H
#define IMCHAT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IMChat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6IMChat17AnimatedImageView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC6IMChat12InputBarView")
@interface InputBarView : UIView
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified inputHeight;
...
@interface InputBarView (SWIFT_EXTENSION(IMChat)) <UITextViewDelegate>
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC6IMChat20UIChatCollectionView")
@interface UIChatCollectionView : UICollectionView
...
@interface UIChatCollectionView (SWIFT_EXTENSION(IMChat))
